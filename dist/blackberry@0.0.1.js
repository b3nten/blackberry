...
freeze([]),tt=Object.assign,te=Object.prototype.hasOwnProperty,lt=(t,e)=>te.call(t,e),j=Array.isArray,W=t=>Pt(t)==="[obj\
ect Map]",ee=t=>typeof t=="string",q=t=>typeof t=="symbol",rt=t=>t!==null&&typeof t=="object",re=Object.prototype.toString,
Pt=t=>re.call(t),jt=t=>Pt(t).slice(8,-1),gt=t=>ee(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,st=t=>{let e=Object.create(
null);return r=>e[r]||(e[r]=t(r))},se=/-(\w)/g,ze=st(t=>t.replace(se,(e,r)=>r?r.toUpperCase():"")),ie=/\B([A-Z])/g,Fe=st(
t=>t.replace(ie,"-$1").toLowerCase()),$t=st(t=>t.charAt(0).toUpperCase()+t.slice(1)),Ne=st(t=>t?`on${$t(t)}`:""),B=(t,e)=>!Object.
...
index]=i,i.index=this.index)}this.parent=void 0}}};function oe(t){return new ae(t)}var h,nt=new WeakSet,Tt=class{constructor(t){
...
for(let t=this.deps;t;t=t.nextDep)St(t);this.deps=this.depsTail=void 0,wt(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){
this.flags&64?nt.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){ut(this)&&this.run()}get dirty(){
return ut(this)}},Wt=0,Y,z;function ce(t,e=!1){if(t.flags|=8,e){t.next=z,z=t;return}t.next=Y,Y=t}function bt(){Wt++}function mt(){
if(--Wt>0)return;if(z){let e=z;for(z=void 0;e;){let r=e.next;e.next=void 0,e.flags&=-9,e=r}}let t;for(;Y;){let e=Y;for(Y=
...
depsTail,i=r;for(;i;){let s=i.prevDep;i.version===-1?(i===r&&(r=s),St(i),ue(i)):e=i,i.dep.activeLink=i.prevActiveLink,i.
...
t.deps&&!ut(t)){t.flags&=-3;return}let r=h,i=y;h=t,y=!0;try{Bt(t);let s=t.fn(t._value);(e.version===0||B(s,t._value))&&(t.
_value=s,e.version++)}catch(s){throw e.version++,s}finally{h=r,y=i,Yt(t),t.flags&=-3}}function St(t,e=!1){let{dep:r,prevSub:i,
nextSub:s}=t;if(i&&(i.nextSub=s,t.prevSub=void 0),s&&(s.prevSub=i,t.nextSub=void 0),r.subsHead===t&&(r.subsHead=s),r.subs===
t&&(r.subs=i,!i&&r.computed)){r.computed.flags&=-5;for(let a=r.computed.deps;a;a=a.nextDep)St(a,!0)}!e&&!--r.sc&&r.map&&
r.map.delete(r.key)}function ue(t){let{prevDep:e,nextDep:r}=t;e&&(e.nextDep=r,t.prevDep=void 0),r&&(r.prevDep=e,t.nextDep=
void 0)}function yt(t,e){t.effect instanceof Tt&&(t=t.effect.fn);let r=new Tt(t);e&&tt(r,e);try{r.run()}catch(s){throw r.
...
deps=r)}return h.onTrack&&h.onTrack(tt({effect:h},t)),e}trigger(t){this.version++,et++,this.notify(t)}notify(t){bt();try{
for(let e=this.subsHead;e;e=e.nextSub)e.sub.onTrigger&&!(e.sub.flags&8)&&e.sub.onTrigger(tt({effect:e.sub},t));for(let e=this.
subs;e;e=e.prevSub)e.sub.notify()&&e.sub.dep.notify()}finally{mt()}}};function Ft(t){if(t.dep.sc++,t.sub.flags&4){let e=t.
dep.computed;if(e&&!t.dep.subs){e.flags|=20;for(let i=e.deps;i;i=i.nextDep)Ft(i)}let r=t.dep.subs;r!==t&&(t.prevSub=r,r&&
(r.nextSub=t)),t.dep.subsHead===void 0&&(t.dep.subsHead=t),t.dep.subs=t}}var ft=new WeakMap,D=Symbol("Object iterate"),ht=Symbol(
"Map keys iterate"),N=Symbol("Array iterate");function b(t,e,r){if(y&&h){let i=ft.get(t);i||ft.set(t,i=new Map);let s=i.
get(r);s||(i.set(r,s=new ve),s.map=i,s.key=r),s.track({target:t,type:e,key:r})}}function R(t,e,r,i,s,a){let n=ft.get(t);
if(!n){et++;return}let o=c=>{c&&c.trigger({target:t,type:e,key:r,newValue:i,oldValue:s,oldTarget:a})};if(bt(),e==="clear")
n.forEach(o);else{let c=j(t),l=c&&gt(r);if(c&&r==="length"){let v=Number(i);n.forEach((u,f)=>{(f==="length"||f===N||!q(f)&&
f>=v)&&o(u)})}else switch((r!==void 0||n.has(void 0))&&o(n.get(r)),l&&o(n.get(N)),e){case"add":c?l&&o(n.get("length")):(o(
n.get(D)),W(t)&&o(n.get(ht)));break;case"delete":c||(o(n.get(D)),W(t)&&o(n.get(ht)));break;case"set":W(t)&&o(n.get(D));break}}
mt()}function C(t){let e=p(t);return e===t?e:(b(e,"iterate",N),I(t)?e:e.map(m))}function xt(t){return b(t=p(t),"iterate",
N),t}var _e={__proto__:null,[Symbol.iterator](){return at(this,Symbol.iterator,m)},concat(...t){return C(this).concat(...t.
map(e=>j(e)?C(e):e))},entries(){return at(this,"entries",t=>(t[1]=m(t[1]),t))},every(t,e){return E(this,"every",t,e,void 0,
...
arguments)},includes(...t){return ot(this,"includes",t)},indexOf(...t){return ot(this,"indexOf",t)},join(t){return C(this).
join(t)},lastIndexOf(...t){return ot(this,"lastIndexOf",t)},map(t,e){return E(this,"map",t,e,void 0,arguments)},pop(){return $(
this,"pop")},push(...t){return $(this,"push",t)},reduce(t,...e){return Dt(this,"reduce",t,e)},reduceRight(t,...e){return Dt(
this,"reduceRight",t,e)},shift(){return $(this,"shift")},some(t,e){return E(this,"some",t,e,void 0,arguments)},splice(...t){
return $(this,"splice",t)},toReversed(){return C(this).toReversed()},toSorted(t){return C(this).toSorted(t)},toSpliced(...t){
return C(this).toSpliced(...t)},unshift(...t){return $(this,"unshift",t)},values(){return at(this,"values",m)}};function at(t,e,r){
let i=xt(t),s=i[e]();return i!==t&&!I(t)&&(s._next=s.next,s.next=()=>{let a=s._next();return a.value&&(a.value=r(a.value)),
a}),s}var de=Array.prototype;function E(t,e,r,i,s,a){let n=xt(t),o=n!==t&&!I(t),c=n[e];if(c!==de[e]){let u=c.apply(t,a);
return o?m(u):u}let l=r;n!==t&&(o?l=function(u,f){return r.call(this,m(u),f,t)}:r.length>2&&(l=function(u,f){return r.call(
this,u,f,t)}));let v=c.call(n,l,i);return o&&s?s(v):v}function Dt(t,e,r,i){let s=xt(t),a=r;return s!==t&&(I(t)?r.length>
3&&(a=function(n,o,c){return r.call(this,n,o,c,t)}):a=function(n,o,c){return r.call(this,n,m(o),c,t)}),s[e](a,...i)}function ot(t,e,r){
let i=p(t);b(i,"iterate",N);let s=i[e](...r);return(s===-1||s===!1)&&Ie(r[0])?(r[0]=p(r[0]),i[e](...r)):s}function $(t,e,r=[]){
fe(),bt();let i=p(t)[e].apply(t,r);return mt(),he(),i}var ge=Ct("__proto__,__v_isRef,__isVue"),Nt=new Set(Object.getOwnPropertyNames(
Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(q));function be(t){q(t)||(t=String(t));let e=p(
...
v_isReadonly")return i;if(e==="__v_isShallow")return s;if(e==="__v_raw")return r===(i?s?we:Jt:s?Te:qt).get(t)||Object.getPrototypeOf(
t)===Object.getPrototypeOf(r)?t:void 0;let a=j(t);if(!i){let o;if(a&&(o=_e[e]))return o;if(e==="hasOwnProperty")return be}
let n=Reflect.get(t,e,F(t)?t:r);return(q(e)?Nt.has(e):ge(e))||(i||b(t,"get",e),s)?n:F(n)?a&&gt(e)?n:n.value:rt(n)?i?Qt(n):
T(n):n}},me=class extends Ut{constructor(t=!1){super(!1,t)}set(t,e,r,i){let s=t[e];if(!this._isShallow){let o=U(s);if(!I(
r)&&!U(r)&&(s=p(s),r=p(r)),!j(t)&&F(s)&&!F(r))return o?!1:(s.value=r,!0)}let a=j(t)&&gt(e)?Number(e)<t.length:lt(t,e),n=Reflect.
set(t,e,r,F(t)?t:i);return t===p(i)&&(a?B(r,s)&&R(t,"set",e,r,s):R(t,"add",e,r)),n}deleteProperty(t,e){let r=lt(t,e),i=t[e],
s=Reflect.deleteProperty(t,e);return s&&r&&R(t,"delete",e,void 0,i),s}has(t,e){let r=Reflect.has(t,e);return(!q(e)||!Nt.
...
return O(`Delete operation on key "${String(e)}" failed: target is readonly.`,t),!0}},ye=new me,xe=new Se,pt=t=>t,H=t=>Reflect.
getPrototypeOf(t);function Ee(t,e,r){return function(...i){let s=this.__v_raw,a=p(s),n=W(a),o=t==="entries"||t===Symbol.
iterator&&n,c=t==="keys"&&n,l=s[t](...i),v=r?pt:e?vt:m;return!e&&b(a,"iterate",c?ht:D),{next(){let{value:u,done:f}=l.next();
...
t==="clear"?void 0:this}}function Ae(t,e){let r={get(s){let a=this.__v_raw,n=p(a),o=p(s);t||(B(s,o)&&b(n,"get",s),b(n,"g\
et",o));let{has:c}=H(n),l=e?pt:t?vt:m;if(c.call(n,s))return l(a.get(s));if(c.call(n,o))return l(a.get(o));a!==n&&a.get(s)},
get size(){let s=this.__v_raw;return!t&&b(p(s),"iterate",D),Reflect.get(s,"size",s)},has(s){let a=this.__v_raw,n=p(a),o=p(
s);return t||(B(s,o)&&b(n,"has",s),b(n,"has",o)),s===o?a.has(s):a.has(s)||a.has(o)},forEach(s,a){let n=this,o=n.__v_raw,
c=p(o),l=e?pt:t?vt:m;return!t&&b(c,"iterate",D),o.forEach((v,u)=>s.call(a,l(v),l(u),n))}};return tt(r,t?{add:k("add"),set:k(
"set"),delete:k("delete"),clear:k("clear")}:{add(s){!e&&!I(s)&&!U(s)&&(s=p(s));let a=p(this);return H(a).has.call(a,s)||
(a.add(s),R(a,"add",s,s)),this},set(s,a){!e&&!I(a)&&!U(a)&&(a=p(a));let n=p(this),{has:o,get:c}=H(n),l=o.call(n,s);l?Ot(
n,o,s):(s=p(s),l=o.call(n,s));let v=c.call(n,s);return n.set(s,a),l?B(a,v)&&R(n,"set",s,a,v):R(n,"add",s,a),this},delete(s){
let a=p(this),{has:n,get:o}=H(a),c=n.call(a,s);c?Ot(a,n,s):(s=p(s),c=n.call(a,s));let l=o?o.call(a,s):void 0,v=a.delete(
s);return c&&R(a,"delete",s,void 0,l),v},clear(){let s=p(this),a=s.size!==0,n=W(s)?new Map(s):new Set(s),o=s.clear();return a&&
R(s,"clear",void 0,void 0,n),o}}),["keys","values","entries",Symbol.iterator].forEach(s=>{r[s]=Ee(s,t,e)}),r}function Gt(t,e){
let r=Ae(t,e);return(i,s,a)=>s==="__v_isReactive"?!t:s==="__v_isReadonly"?t:s==="__v_raw"?i:Reflect.get(lt(r,s)&&s in i?
r:i,s,a)}var Me={get:Gt(!1,!1)},Re={get:Gt(!0,!1)};function Ot(t,e,r){let i=p(r);if(i!==r&&e.call(t,i)){let s=jt(t);O(`R\
...
sion if possible.`)}}var qt=new WeakMap,Te=new WeakMap,Jt=new WeakMap,we=new WeakMap;function De(t){switch(t){case"Objec\
t":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Oe(t){return t.
__v_skip||!Object.isExtensible(t)?0:De(jt(t))}function T(t){return U(t)?t:Xt(t,!1,ye,Me,qt)}function Qt(t){return Xt(t,!0,
...
2?i:r);return s.set(t,o),o}function U(t){return!!(t&&t.__v_isReadonly)}function I(t){return!!(t&&t.__v_isShallow)}function Ie(t){
return t?!!t.__v_raw:!1}function p(t){let e=t&&t.__v_raw;return e?p(e):t}var m=t=>rt(t)?T(t):t,vt=t=>rt(t)?Qt(t):t;function F(t){
return t?t.__v_isRef===!0:!1}var Zt=1,G=3,it={},Et=[],Le="http://www.w3.org/2000/svg",It=function(t){this._vevents[t.type](
...
e):t.setAttribute(e,i))},_t=(t,e)=>{var r=t.props,i=t.type===G?document.createTextNode(t.tag):(e=e||t.tag==="svg")?document.
...
return i.innerHTML=r.dangerouslySetInnerHTML.__html,t.node=i;for(var a=0;a<t.children.length;a++)i.appendChild(_t(t.children[a]=
P(t.children[a]),e));return t.node=i},w=(t,e,r,i,s)=>{if(r!==i)if(r!=null&&r.type===G&&i.type===G)r.tag!==i.tag&&(e.nodeValue=
i.tag);else if(r==null||r.tag!==i.tag)e=t.insertBefore(_t(i=P(i),s),e),r!=null&&t.removeChild(r.node);else{var a,n,o,c,l=r.
...
x)for(;_<=A;)e.insertBefore(_t(f[_]=P(f[_++]),s),(n=u[d])&&n.node);else if(_>A)for(;d<=x;)e.removeChild(u[d++].node);else{
...
X[g].node)}}return i.node=e},P=t=>t!==!0&&t!==!1&&t?t:Mt(""),kt=t=>t.nodeType===G?Mt(t.nodeValue,t):At(t.nodeName.toLowerCase(),
it,Et.map.call(t.childNodes,kt),Zt,t),At=(t,e,r,i,s)=>({tag:t,props:e,key:e.key,children:r,type:i,node:s}),Ce=(t,e,r=Et)=>At(
t,e,Array.isArray(r)?r:[r]),Mt=(t,e)=>At(t,it,Et,G,e),Rt=(t,e)=>e.flat(),J=(t,e,...r)=>typeof t=="function"?t(e,r):Ce(t,
e||{},r.flatMap(i=>typeof i=="string"||typeof i=="number"?Mt(i):i)),Pe=it,dt=(t,e,r={})=>(dt.ctx=r,(e=w(e.parentNode,e,e.
vdom||kt(e),t)).vdom=t,dt.ctx=it,e);Symbol.metadata??=Symbol("metadata");var K=new Map,ct=null,je=()=>(ct===null&&(ct=Array.
from(document.styleSheets).map(t=>{let e=new CSSStyleSheet,r=Array.from(t.cssRules).map(i=>i.cssText).join(" ");return e.
replaceSync(r),e})),ct),V=!0,Ge=t=>V=t,Lt=!1,Kt=class extends HTMLElement{static styles="";static use_global_styles=!1;static get useGlobalStyles(){
...
removeAttribute.bind(this);on_mount(){}onMount(){}on_mounted(){}onMounted(){}on_unmount(){}onUnmount(){}constructor(){super(),
typeof document<"u"&&!this.constructor.light_dom&&this._construct_shadow_dom(),V&&!Lt&&(console.warn("Ivysaur is running\
 in development mode. Call set_dev(false) to disable this warning."),Lt=!0)}render(){V&&!this.constructor.light_dom&&console.
warn("No render method defined for",this.constructor.name)}connectedCallback(){this._rootEffectScope?.active&&this._rootEffectScope.
stop(),this._rootEffectScope=oe(),this._rootEffectScope.run(()=>{try{this.onMount?.(),this.on_mount?.()}catch(t){this._log_error(
t,"on mount")}yt(()=>{let t;try{t=this.render.call(this)}catch(e){this._log_error(e,"render")}if(!this.constructor.light_dom&&
t)try{dt(J("shadow-root",{},t),this.root_node,{host:this})}catch(e){this._log_error(e,"dom update")}});try{this.onMounted?.(),
...
this.constructor.use_global_styles)try{this.adoptedStyleSheets.push(...je())}catch(r){this._log_error(r,"adding global s\
tylesheets")}this.root_node=document.createElement("shadow-root"),this.shadowRoot.appendChild(this.root_node)}_rootEffectScope;_reactive_states=T(
{})},qe=String.raw;function Je(){return function(t,{kind:e,name:r}){if(e==="accessor")return{get(){return this._reactive_states[r]},
...
t.Cache.set(e,r()),this.call=t.Cache.get(e)}},Q=(t,e)=>{if(Array.isArray(t))return J(Rt,{},t.flatMap(n=>Q(n,e)));if(t.nodeType!=
...
"template"?We(n,e):Q(n,e));return a&&!a.call(e)?null:J(r,i,...s)},We=(t,e)=>{let r,i,s;for(let o of t.attributes)o.nodeName.
...
null:J(Rt,{},...a)},Vt=t=>{if(t.tagName!=="TEMPLATE"||typeof t.getAttribute("blackberry")!="string")return;let e=t.getAttribute(
...
c,this.observedAttributes,l,T,yt),this.__internal_data=c}render(){return Q(Array.from(a.children),this.__internal_data).
...
readyState){case"loading":case"interactive":addEventListener("DOMContentLoaded",e);break;case"complete":e()}};export{Rt as Fragment,V as IS_DEV,Kt as Ivysaur,Qe as attribute,qe as css,nr as default,yt as effect,oe as effectScope,J as h,
Kt as ivysaur,T as reactive,dt as render,Ge as setDev,Ge as set_dev,Je as state};
/*! Bundled license information:

ivysaur/dist/ivysaur@0.0.2.js:
  (*! Bundled license information:
