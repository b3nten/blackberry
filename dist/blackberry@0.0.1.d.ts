...
declare function initBlackberry(): void;
/**
...
export const attribute: (name: string) => <This, T>(value: ClassAccessorDecoratorTarget<This, T> | Function, context: ClassAccessorDecoratorContext<This, T> | ClassGetterDecoratorContext<This, T>) => void;
export const component: (name: string) => <Class extends abstract new (...args: any) => any = abstract new (...args: any) => any>(value: Class, context: ClassDecoratorContext<Class>) => Class | void;
