...
export const attribute: <This, T>(value: ClassAccessorDecoratorTarget<This, T>, context: ClassAccessorDecoratorContext<This, T>) => void;
declare const BlackberryElement$1: typeof BlackberryElement;
export declare const Component: typeof BlackberryElement;

export {
	BlackberryElement$1 as BlackberryElement,
	stop$1 as stop,
};
